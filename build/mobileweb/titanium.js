...
var require = {
	app: {
		analytics: true,
		copyright: "2015 by stoica.catalin",
		deployType: "development",
		description: "",
		guid: "49f66a37-7387-4a01-9000-b89a9dc7dc32",
		id: "test.com",
		name: "test",
		names: {},
		publisher: "stoica.catalin",
		url: "http://",
		version: "1.0"
	},
	has: {
...
require("Ti/App/Properties", function(p) {
	...
	p.setString("appc-app-id","55647509c11aa45718743bac");
	...
	p.setString("acs-oauth-secret-development","8vVMOJ7Tu3VRPWzkoxZaDH5PMwXZMQSh");
	p.setString("acs-oauth-key-development","x0Ev2NivYlD9zftqIGwx2lefdHfkaCEH");
	p.setString("acs-api-key-development","89ZqtNJ9pVRHk8GQBgGym5cWb3JOt1EW");
	p.setString("acs-username-development","appc_app_user_dev");
	p.setString("acs-password-development","nSfEzjkYgxZamW6ixH");
	...
	p.setString("acs-oauth-secret-production","2ymUa3iNDnDyRGbSryGFpoB8QWKweUDC");
	p.setString("acs-oauth-key-production","3qjHBo16RQ9EurXtxAWltRq38SUONFGG");
	p.setString("acs-api-key-production","GYCLvRered0Vvn4UFMk9qBrbcDGCfUds");
	p.setString("acs-username-production","appc_app_user");
	p.setString("acs-password-production","oxDDqV7r4q6krJmHNG");
	p.setString("appc-org-id","100031733");
	p.setString("appc-creator-user-id","d6930faa-af14-4294-a14b-bfac12a53637");
});
